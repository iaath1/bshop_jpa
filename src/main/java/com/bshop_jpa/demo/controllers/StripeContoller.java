...
public class StripeContoller {
    ...
    private static final Logger log = LoggerFactory.getLogger(StripeContoller.class);
    ...
    @PostMapping("/webhook")
    public @ResponseBody String webhook(@RequestHeader("Stripe-Signature") String payloadSignature, @RequestBody String payload) {
            ...
            switch (event.getType()) {
                case "checkout.session.completed":
                    ...
                    if(session != null) {
                        ...
                        order.setStatus(statusService.findStatusByName("PAID"));
                        orderService.saveOrder(order);
                        emailService.sendOrderInfoEmail(statusService.findStatusByName("PAID"), order);
                    }
                    break;
